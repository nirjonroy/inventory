            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>Dcart </span></a>
                    </div>
                </div>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{route('add.customer')}}">Add</a></li>
                                    <li><a href="{{route('all.customer')}}">All</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{route('add.supplier')}}">Add</a></li>
                                    <li><a href="{{route('all.supplier')}}">All</a></li>
                           ...
                           <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{route('add.salary')}}">Add</a></li>
                                    <li><a href="{{route('all.salary')}}">All</a></li>
...
<script type="text/javascript" src="{{asset('https://unpkg.com/sweetalert@2.1.2/dist/sweetalert.min.js')}}"></script>    
    <script type="text/javascript">
        @if(Session::has('message'))
        var type= "{{Session::get('alert-type', info)}}"
        switch(type){
            case 'info':
            toster.info("{{Session::get('message')}}");
            break;
            case 'success':
            toster.success("{{Session::get('message')}}");
            break;
            case 'warning':
            toster.warning("{{Session::get('message')}}");
            break;
            case 'error';
            toster.error("{{Session::get('message')}}");
            break;
        }
        @endif
    </script>
    <script type="text/javascript">
        $(document).on("click", "#delete", function(e){
            ...
            swal({
                ...
                text: "Once Delete, this will parmanently delete",
                icon: "warning",
                buttons: true,
                dangerMode: true, 
            })
